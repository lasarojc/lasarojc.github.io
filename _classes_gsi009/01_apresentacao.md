...
\item 31/10 Seminários: Relações de Gênero
\item 07/11 Palestra convidada
\item 14/11 Palestra convidada
\item 21/11 Palestra convidada
\item 28/11 Palestra convidada
\item 5/12 Palestra convidada
\item 12/12 Palestra convidada
\item 19/12 Fechamento da disciplina
\end{itemize}
\end{frame}

\begin{frame}{Seminários}
\begin{itemize}
\item Técnicos x Não técnicos
\item 75 minutos
\item Discussão
\item Legislação
\item 5 perguntas de múltiplas alternativas (5) com resposta abordada no seminário entregues \emph{dois dias antes}
\item Seis grupos
\end{itemize}
\end{frame}

\begin{frame}[allowframebreaks]{Palestras}
\begin{itemize}
	\item Profissionais da área de Informática e Computação
	\item 4 anos de experiência
	\item ``Causos''
	\item Discussão
	\item 5 perguntas de múltiplas alternativas (5) com resposta abordada no seminário entregues \emph{até um dia após a palestra}
	\item 6 grupos
	\item 70 minutos
	
	\item Sugestão de tópicos	
	\begin{itemize}
	\item Administrador de Redes
	\item Administrador de Bancos de Dados
	\item Analista de Sistemas
	\item Analista de Requisitos
	\item Analista de Suporte
	\item Analista de Segurança					
	\item Arquiteto de Software					
	\item Analista de Testes
	\item Bio-informata
	\item Consultor					
	\item Desenvolvedor Front-End					
	\item Desenvolvedor Back-End					
	\item Desenvolvedor Aplicações Móveis					
	\item Desenvolvedor de Sistemas embarcados					
	\item Desenvolvedor de Games
	\item Engenheiro de Software
	\item Empreendedor
	\item Especialista em ferramentas inteligentes					
	\item Especialista em infraestruturas de TI					
	\item Especialista em mídias sociais					
	\item Gerente de projeto
	\item Gestor de qualidade					
	\item Pesquisador
	\item Designers					
	\item X Informata (Bio, Geo, Fisio, Astro, ...)					
	\end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item Questionários respondidos 40\%
	\item Questionários providos 15\%
	\item Seminários 45\%
	\item \url{piazza.com/ufu.br/semester12018/gsi009}
\end{itemize}
\end{frame}
...
\pause Por quê não pode modificar o software que compra?

\end{frame}

\begin{frame}{Sofware Livre e Propriedade Intelectual}
\begin{itemize}
	\item O quê é?
	\item A filosofia por trás.
	\item Como ganhar dinheiro?
\end{itemize}
\end{frame}
...
%https://www.youtube.com/watch?v=GFU65PxIW30
%https://www.youtube.com/watch?v=Gz8-JsgBdtw
...
\href{https://pt.wikipedia.org/wiki/Ética}{Fonte mais que confiável}
\end{frame}
...
\href{https://pt.wikipedia.org/wiki/Moral}{Fonte mais que confiável}
...
\begin{frame}{Falta de ética ... na vida}
\begin{itemize}
\item achar dinheiro e não devolver
\item comer o lanche do seu colega de república (sem autorização)
\item violar acordo de monogamia

\pause
\item vender algo com lucro exorbitante? 
\pause Interessantemente, é normalmente aceito que negócios tentem conseguir o maior lucro possível.
\end{itemize}
\end{frame}


\begin{frame}{... na Universidade}
\begin{itemize}
\item não reposição de aula.
\item colar nas provas.	
\end{itemize}

\url{https://rbribeiro.wordpress.com/2015/06/24/como-e-dar-aula-no-ensino-superior-e-a-corrupcao-na-universidade/}
\end{frame}

\begin{frame}{... na Empresa}
\begin{itemize}
\item ética no trabalho
\item chegar atrasado/sair mais cedo
\item sabotar seus colegas
\item pisar nos seus colegas
\end{itemize}
\end{frame}

\begin{frame}[allowframebreaks]{... no Exercício da Profissão}

Conjunto de normas de conduta a serem praticadas no exercício da profissão.

\framebreak

\textbf{Juramento de Hipócrates}
...
\begin{block}{Juramento de Hipócrates}
...
\begin{frame}{Ética na Computação}
...
\begin{frame}{Falta de}
\includegraphics[width=.7\textwidth]{images/vw_testeemissao}

\href{https://www.scientificamerican.com/article/volkswagen-uses-software-to-fool-epa-pollution-tests/}{Fonte}
\end{frame}

\begin{frame}{Falta de}
\includegraphics[width=.7\textwidth]{images/piratebay_altcoin}

\href{https://torrentfreak.com/the-pirate-bay-website-runs-a-cryptocurrency-miner-170916/}{Fonte}
\end{frame}

\begin{frame}{Falta de}
Roomba pode vender mapa da sua casa para parceiros.

\href{https://gizmodo.com/roombas-next-big-step-is-selling-maps-of-your-home-to-t-1797187829}{Fonte}
\end{frame}

\begin{frame}{Falta de}
\includegraphics[width=.7\textwidth]{images/fb_spy}
\end{frame}
...
\begin{frame}{Sobre os dilemas de veiculos auto dirigiveis}
...
\begin{frame}{Falta de}
\includegraphics[width=.7\textwidth]{images/safe_image}

\end{frame}

\begin{frame}{Falta de}
\includegraphics[width=.7\textwidth]{images/doutoradomau}

\end{frame}

\begin{frame}{Pós-graduação}
Meu vizinho já fez três. Mas meu professor disse que leva quatro anos. Como assim?
\end{frame}
...
\begin{frame}{O quê?}
\begin{itemize}
	\item Estudo pós curso de graduação
	\item Assume conhecimento prévio, obtido na graduação
	\item Diversos tipos
	
	\item \emph{latu sensu}
	\item \emph{stricto sensu}
\end{itemize}
\end{frame}

\begin{frame}{\emph{stricto sensu}}
	Voltados para atuação na academia e pesquisa de forma geral. Também é requisito para a docência no ensino superior.
	\begin{itemize}
		\item mestrado
		\item doutorado
	\end{itemize}
...
\begin{frame}{\emph{latu sensu}}
	Voltados para atuação na indústria
\begin{itemize}
...
\begin{frame}{Aperfeiçoamento}
\begin{itemize}
	\item  até 359 horas 
	\item associado a uma função
	\begin{itemize}
		\item contabilidade industrial
		\item infraestrutura CISCO
		\item exportação para a China
	\end{itemize} 
\end{itemize}
\end{frame}

\begin{frame}{Especialização}
\begin{itemize}
	\item a partir de 360 horas 
	\item monografia 
	\item Especialista em redes de computadores
	\item Especialista em cirurgia ortopédica
	\item MBA: \emph{master of busyness administration}
	\begin{itemize}
		\item no Brasil = especialização
	\end{itemize} 
	
\end{itemize}
\end{frame}

\begin{frame}{Mestrado}
\begin{itemize}
	\item dois anos
	\item dissertação de mestrado (ou \emph{master thesis})
	\item Mestre em Sistemas de Informação
	\item Mestre em Engenharia Biomédica
	\item Créditos podem ser usados para obter título de especialista
	\item \emph{Master of Science in} ...
	\item \emph{Master of Engineering in} ...
\end{itemize}
\end{frame}

\begin{frame}{Doutorado}
\begin{itemize}
	\item quatro anos
	\item tese de doutorado (ou \emph{PhD dissertation})
	\item Doutor em Ciência da Computação
	\item Créditos podem ser usados para obter título de especialista
	\item \emph{Docteur}, \emph{Philosophy Doctor}
\end{itemize}
\end{frame}

\begin{frame}{Profissional x Acadêmico}
\begin{itemize}
	\item Foco do problema a ser resolvido
	\item Colaboração com indústria
	\item Transferência rápida de conhecimento
	\item Protótipos
\end{itemize}
\end{frame}
...
\begin{frame}{Mestrado}
\begin{itemize}
	\item Iniciação científica -- Método científico
	\item Revisão bibliográfica -- busca e entendimento de resultados
	\item Reprodução  -- aplicação criativa de resultados
\end{itemize}
\end{frame}

\begin{frame}{Doutorado}
\begin{itemize}
	\item Pesquisa autônoma -- Método científico
	\item Revisão bibliográfica -- busca e entendimento de resultados e identificação de deficiências
	\item Produção -- novos problemas e métodos de resolução -- originalidade
\end{itemize}
\pause Nas engenharias, aplicação de métodos a um novo problema é considerado um bom trabalho de doutorado.
\end{frame}
...
\begin{itemize}
	\item Pós-doutorado
	\begin{itemize}
		\item atividade temporária (bico) para doutores (e.g, auxiliar de laboratório)
		\item não confundir com sabático
	\end{itemize}
	\item Livre-docente
	\item Titular
\end{itemize}
...
\begin{frame}{Compensa?}
\begin{itemize}
	\item Perfil
	\item Retorno financeiro 
\end{itemize}
\end{frame}

\begin{frame}
\href{https://www.topuniversities.com/student-info/careers-advice/masters-phd-salary-benefits}{Diferença de salários}
\end{frame}

\begin{frame}{No Brasil}
Doutores estão presos às universidades, com raras exceções.

As privadas só contratam o mínimo.
\end{frame}

\begin{frame}
\href{http://noticias.universia.com.br/ciencia-tecnologia/noticia/2005/08/16/465949/fazer-pos-graduao-ou-no-eis-questo.html}{fazer pós graduação ou não, eis a questão}
\end{frame}
...
É difícil provar o assédio sexual, porque, em regra, essa conduta 
